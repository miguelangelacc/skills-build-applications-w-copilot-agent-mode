...
async function seedDatabase() {
  try {
    ...
    console.log(`   Teams: ${await Team.countDocuments()} documents`);
    console.log(`   Activities: ${await Activity.countDocuments()} documents`);
    console.log(`   Workouts: ${await Workout.countDocuments()} documents`);
    console.log(`   Leaderboard: ${await Leaderboard.countDocuments()} documents\n`);
